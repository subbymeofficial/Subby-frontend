      ...
      <div className="max-w-2xl space-y-6">
        ...
        <div className="rounded-lg border bg-card p-6 card-shadow">
          ...
          <div className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <p><span className="font-medium text-foreground">Role:</span> Contractor</p>
            <p>
              <span className="font-medium text-foreground">Login method:</span>{" "}
        ...
        <div className="rounded-lg border bg-card p-6 card-shadow">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Sign out of your account.</p>
