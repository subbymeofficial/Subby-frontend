  ...
  const content = (
    <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3 text-sm">
      <div className="flex items-center gap-2 text-white">
        ...
        <span className="font-semibold">Founding Member — first year free</span>
        <span className="hidden text-white/80 sm:inline">
          · First 500 contractors pay nothing for 12 months, then standard pricing. Normally {monthly}/mo.
        </span>
      </div>
